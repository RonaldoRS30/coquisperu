...
jQuery(document).ready(function () {
    ...
    /*$("#grabarGuiarem").click(function () {
     ...
     $("#grabarGuiarem").click(function () {
        ...
        if (tipo_oper=="V" && $("#cliente").val()=="") {
            Swal.fire({
                icon: "warning",
                title: "Ingrese un cliente.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
            $("#cliente").focus();
            return false;
        ...
        if ($("#punto_partida").val()=="") {
            Swal.fire({
                icon: "warning",
                title: "Ingrese dirección de origen.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
            $("#punto_partida").focus();
        ...
        if ($("#punto_llegada").val()=="") {
            Swal.fire({
                icon: "warning",
                title: "Ingrese dirección de destino.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
            $("#punto_llegada").focus();
        ...
        if ($("#tipo_movimiento").val()=="18") {
            if ($("#punto_partida").val()!=$("#punto_llegada").val()) {
                Swal.fire({
                    icon: "warning",
                    title: "Para traslado ITINERANTE las dirección de ORIGEN debe ser igual a la de DESTINO.",
                    html: "<b>No se registra la guia.</b>"
                });
                $("#punto_partida").focus();
                return false;
        ...
        if ( $("#ubigeo_partida").val().length < 5 || $.isNumeric($("#ubigeo_partida").val()) == false ){
            ...
            Swal.fire({
                icon: "warning",
                title: "Por favor seleccione un ubigeo de ORIGEN valido.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
        ...
        if ( $("#ubigeo_llegada").val().length < 5 || $.isNumeric($("#ubigeo_llegada").val()) == false){
            ...
            Swal.fire({
                icon: "warning",
                title: "Seleccione un ubigeo de LLEGADA valido.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
        ...
        if ( $("#empresa_transporte").val() == "" ){
            ...
            Swal.fire({
                icon: "warning",
                title: "Seleccione un ubigeo de DESTINO valido.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
        ...
        if ( $("#placa").val() == "" ){
            ...
            Swal.fire({
                icon: "warning",
                title: "Indique un numero de placa.",
                html: "<b>Si no la conoce complete con cero (0).</b>",
                timer: 6000
            });
            $("#placa").focus();
            return false;
        ...
        if ( $("#nombre_conductor").val() == "" ){
            ...
            Swal.fire({
                icon: "warning",
                title: "Indique el nombre del conductor.",
                html: "<b>Si no la conoce complete con guión (-).</b>",
                timer: 6000
            });
        ...
        if ( $("#recepciona_dni").val() == "" ){
            ...
            Swal.fire({
                icon: "warning",
                title: "Indique el DNI del conductor.",
                html: "<b>Si no la conoce complete con 8 ceros (00000000).</b>",
                timer: 6000
            });
        ...
        if ( $("#mod_transporte").val() == "" ){
            //alert('Indique el DNI del conductor.');
            Swal.fire({
                icon: "warning",
                title: "Indique modalidad de transporte.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
            $("#mod_transporte").focus();
            return false;
        }

        if ( $("#nombre_empresa_transporte").val() == "" ){
            //alert('Indique el DNI del conductor.');
            Swal.fire({
                icon: "warning",
                title: "Agregue el nombre de la empresa de transporte.",
                html: "<b>Si no la conoce complete con guión (-).</b>",
                timer: 6000
            });
            $("#mod_transporte").focus();
        ...
        if ( $("#peso_total").val() == "" ){
            ...
            Swal.fire({
                icon: "warning",
                title: "Indique el peso bruto total (Kg).",
                html: "<b>Si no la conoce complete con cero (0).</b>",
                timer: 6000
            });
            $("#mod_transporte").focus();
        ...
        if ( $("#num_bultos").val() == "" ){
            ...
            Swal.fire({
                icon: "warning",
                title: "Indique el numero de bultos.",
                html: "<b>Si no la conoce complete con cero (0).</b>",
                timer: 6000
            });
            $("#mod_transporte").focus();
        ...
        if(n!=0){
            ...
            Swal.fire({
                icon: "warning",
                title: "Ingrese al menos un producto.",
                html: "<b>No se registra la guia.</b>",
                timer: 6000
            });
            return false;
