...
jQuery(document).ready(function () {
    ...
    $("#grabarComprobante").click(function () {
        ...
        if ( $("#idSerie").val() == "" || $("#idNumero").val() == "" ){
            Swal.fire({
                icon: "warning",
                title: "Debe relacionar un documento",
                html: "<b>Ingrese serie y numero relacionado.</b>",
                timer: 6000
            });
            return false;
        }
        ...
        if ( $("#origenDocumento").val() == "" || $("#guiaReferente").val() == "" ){
            Swal.fire({
                icon: "warning",
                title: "Debe asociar una factura, boleta o comprobante primero.",
                html: "<b>La generación fue cancelada.</b>",
                timer: 6000
            });
            return false;
        }
        ...
        if (n == 0) {
            ...
            return false;
        } else if($('#cliente').val() == "" && $('#proveedor').val() == ""){
            Swal.fire({
                icon: "warning",
                title: "Seleccione la empresa titular del documento.",
                html: "<b>La generación fue cancelada.</b>",
                timer: 6000
            });
            return false;
        ...
        $.ajax({
                ...
                success: function (data) {
                    if (data.result == "success"){
                        ...
                        $('#serie').val(data.info.serie);
                        $('#numero').val(data.info.numdoc);
