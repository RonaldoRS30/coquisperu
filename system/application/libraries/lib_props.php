...
class Lib_props
{
  ...
  public function comprobante_pdf_ticket($codigo, $enviarcorreo = false)
  {
    ...
    foreach ($detalle_comprobante as $indice => $valor) {
      ...
      $detaProductos = $detaProductos . '
                <tr>
                <td style="border-top:#D1D1D1 1mm solid; text-align:left; "><b>' . $cantidad . '</b></td>
                <td style="border-top:#D1D1D1 1mm solid; text-align:left; ">' . $medidaDetalle . '</td>
                <td style="border-top:#D1D1D1 1mm solid; text-align:left; ">' . $nombre_producto . ' </td>
                <td style="border-top:#D1D1D1 1mm solid; text-align:right; ">' . $simbolo. number_format($valor->CPDEC_Pu_ConIgv, 2) . '</td>
                <td style="border-top:#D1D1D1 1mm solid; text-align:right; ">' . $simbolo. number_format($valor->CPDEC_Total, 2) . '</td>
                </tr>';
    }
    ...
    $logoticket = base_url() . 'assets/img/logoticket.png';
    ...
    $cabeceraHTML .= '
              <tr>
                <td style="text-align: center; padding: 2px;">
                  <img src="' . $logoticket . '" alt="logoticket" style="width: 150px; height: 70px;" />
                </td>
              </tr>
              ';
...
$this->pdf->writeHTML($cabeceraHTML, true, false, true, '');
    ...
    $clienteHTML = '
              ...
              ' . $direccion . '
              <tr>
              <td><b>FECHA DE EMISIÓN:</b> ' . $fecha . ' '.$hora.'</td>
              </tr>
              <tr>
    ...
    $productoHTML = '
              <table border="0">
              <tr>
              <td style="text-align:left;  width:10%;"><b>CAN</b></td>
              <td style="text-align:left;  width:13%;"><b>U.M.</b></td>
    ...
    $gratuitaHTML = ($gratuito > 0 && $total==0) ? '<tr>
              <td><b>TRANSFERENCIA GRATUITA DE UN BIEN O SERVICIO PRESTADO GRATUITAMENTE</b></td>
              </tr>' : '';
  ...
  public function comprobante_pdf_a4($codigo, $flagPdf = 1, $enviarcorreo = false)
  {
    ...
    foreach ($detalle_comprobante as $indice => $valor) {
      ...
      $medidaDetalle    = ($valor->UNDMED_Simbolo != "") ? $valor->UNDMED_Simbolo : "ZZ";
      $medidaDescripcion = isset($unidadMedidaDescripcion[$medidaDetalle]) ? $unidadMedidaDescripcion[$medidaDetalle] : $medidaDetalle;
      $tipo_afectacion  = $valor->AFECT_Codigo;
      ...
      $detaProductos = $detaProductos . '
                ...
                <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:center;">' . $medidaDescripcion . '</td>
                <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; text-align:left;">' . $nombre_producto . '</td>
    ...
    $productoHTML = '
        ...
        <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:2.4cm;">U.M</th>
        <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:12.3cm;">DESCRIPCIÓN</th>
        <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:1.5cm;">P/U</th>
        <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:1.5cm;">TOTAL</th>
        </tr>
        ' . $detaProductos . '
    ...
    $gratuitaHTML = ($total == 0 && $gratuito>0) ? '<tr>
        <td style="text-align:left; width:18.5cm;"><b>TRANSFERENCIA GRATUITA DE UN BIEN O SERVICIO PRESTADO GRATUITAMENTE</b></td>
        </tr>' : '';  
    ...
    $othersFormasHTML = '
        <tr>
          ...
          <td colspan=""style="width:15.5cm;">'.$formapago_desc.': '.$simbolo_moneda.' '.(number_format($montoPayMain, 2)).'';
  ...
  public function guiarem_pdf($codigo, $flagPdf = 0, $enviarcorreo = false)
  {
    ...
    foreach ($detalle_guiarem as $indice => $valor) {
      ...
      $detaProductos = $detaProductos. '<tr bgcolor="'.$bgcolor.'">
                    ...
                    <td style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; border-bottom:1px #000 solid; text-align:center;">'.number_format($peso,2).'</td>
                </tr>';
    }
    ...
    $clienteHTML = '
          ...
          <td style="text-align:left;">' . $peso_total . ' Kg</td>
          </tr>
          <tr>
          ...
          <table style="font-size:7pt;" border="0" cellpadding="0.05cm">
          <tr bgcolor="'.$this->color.'">
          <td colspan="4" style="font-weight:bold; text-align: left; color: white;">DATOS DEL TRANSPORTE</td>
          </tr>
          <tr>
          <td style="width:6cm; font-weight: bold; text-indent:1cm;">TRANSPORTISTA:</td>
          <td colspan="3" style="text-align:left;">' . $ruc_empresa_transporte . ' ' . strtoupper($nombre_empresa_transporte) . '</td>
          </tr>
          <tr>
          <td style="width:6cm; font-weight: bold; text-indent:1cm;">VEHICULO:</td>
          <td style="text-align:left;">' . $placa . '</td>
          <td style="width:6cm; font-weight: bold; text-indent:1cm;">REGISTRO MTC:</td>
          <td style="text-align:left;">' . $registro_mtc . '</td>
          </tr>
          <tr>
          ...
          <td style="width:6cm; font-weight: bold; text-indent:1cm;">BREVETE Nº:</td>
    ...
    $productoHTML = '<table cellpadding="0.1cm" style="font-size:8pt;">
                    <tr bgcolor="#ce7974" style="font-size:8pt;">
                        ...
                        <th style="border-left: #cccccc 1mm solid; border-right: #cccccc 1mm solid; border-bottom:#cccccc 1mm solid; border-top:#cccccc 1mm solid; font-style:italic; font-weight:bold; text-align:center; width:20%;">PESO KG</th>
                    </tr>
                    '.$detaProductos.'
                </table>';
    $this->pdf->writeHTML($productoHTML, true, false, true, '');
