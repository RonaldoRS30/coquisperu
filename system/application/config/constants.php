...
define('TITULO',                                'GRUPO COQUIS PERU | OSA-ERP');
...
define('CSS', 'v-4.0.0.3');
define('JS', 'v-4.0.0.3');
define('IMG', 'v-4.0.0.0');

// TAMAÑO LIMITE DE DETALLES EN LOS DOCUMENTOS
define('VENTAS_GUIA', 50);
define('COMPRAS_GUIA', 50);
define('VENTAS_FACTURA', 50);
define('VENTAS_BOLETA', 50);
define('VENTAS_COMPROBANTE', 50);

define('COMPRAS_FACTURA', 50);
define('COMPRAS_BOLETA', 50);
