            ...
            <section>
                <div class="row fuente8 py-1">
                    ...
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        ...
                        <select id="txtUnidad" name="txtUnidad" class="form-control w-porc-90 h-2"> <?php
                            foreach ($unidades as $i => $val) { ?>
                                <option value="<?=$val->UNDMED_Codigo?>"><?="$val->UNDMED_Descripcion | $val->UNDMED_Simbolo";?></option> <?php
                            } ?>
                        </select>
                    </div>
        ...
        $("#buscar").click(function(){
            ...
            $('#table-stock').DataTable({ responsive: true,
                ...
                ajax:{
                        url : "<?=base_url();?>index.php/almacen/almacenproducto/datatable_almacen_producto",
                        type: "POST",
                        data: { txtCodigo: codigo, txtNombre: producto, txtFamilia: familia, txtMarca: marca, txtModelo: modelo ,txtUnidad:txtUnidad,almacen:almacen},
                        error: function(){
                        }
                },
                language: spanish
