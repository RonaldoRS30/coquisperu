                ...
                <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
                    <div class="acciones">
                        <div id="botonBusqueda">
                            ...
                            <ul class="lista_botones" id="nuevoProducto" >
                    ...
                    <table class="fuente8 display" id="table-productos">
                        <thead>
                            <tr class="cabeceraTabla">
                                <th style="" data-orderable="true">CÓDIGO</th>
                                <th style="width: 20%;" data-orderable="true">NOMBRE</th>
                                <th style="" data-orderable="true">CATEGORÍA</th>
                                <th style="" data-orderable="true"><?=($flagBS == "B") ? "MARCA" : "";?></th>
                                <th style="" data-orderable="false">UNIDAD MEDIDA</th>
