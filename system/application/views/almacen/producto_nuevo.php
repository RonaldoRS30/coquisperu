        ...
        <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
            <div class="row">
                ...
                <form id="form_nvo" method="POST" action="#">
                    <div class="row form-group header" style="font-size: 15pt">
                        ...
                        <div class="col-sm-1 col-md-1 col-lg-1">
                            <button type="button" class="btn btn-info nvo_limpiar">NUEVO PRODUCTO</button>
                        </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="row form-group font-9" >
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <label for="nvo_familia">CATEGORÍA:</label>
                    ...
                    <div class="row form-group font-9">
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            ...
                            <input type="number" id="nvo_preciocosto" name="nvo_preciocosto" value="0" class="form-control h-2 w-porc-90" <?=($modo == "nuevo") ? "readonly" : "";?> />
                        </div>
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <label for="nvo_peso">PESO:</label>
                            <input type="number" id="nvo_peso" name="nvo_peso" value="0" class="form-control h-2 w-porc-90"/>
                        </div>
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <label for="nvo_volumen">VOLUMEN:</label>
                            <input type="number" id="nvo_volumen" name="nvo_volumen" value="0" step="0.01" class="form-control h-2 w-porc-90"/>
                        </div>
                        <div class="col-sm-2 col-md-2 col-lg-2">
                        </div>
                        <div class="col-sm-1 col-md-1 col-lg-1">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" onclick="cancelar_procuto()">Cancelar</button>
                </div>
            </div>
        </div>
    </div>
      ...
      $.ajax({
        ...
        success: function(data){
          if (data.match == true) {
            ...
            $("#nvo_peso").val(info.nvo_peso);
            $("#nvo_volumen").val(info.nvo_volumen);
...
function cancelar_procuto(){
    var base_url    = $("#base_url").val();
    url             = base_url+"index.php/almacen/producto/productos/B";
    location.href   = url;
}
</script>