...
<h3>REPORTE DE <?php echo ($tipo_oper=="V")?"VENTAS":"COMPRAS"?> POR PRODUCTOS</h3>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
                    ...
                    <thead>
                        ...
                        <td style="width:08%" data-orderable="false">PRECIO</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //AUTOCOMPLETE CLIENTE/PROVEEDOR
        if (tipo_oper=="V") {
            var url_nombre  = "<?php echo base_url(); ?>index.php/ventas/cliente/autocomplete/";
            var url_doc     = "<?php echo base_url(); ?>index.php/ventas/cliente/autocomplete_ruc/";
        }else{
            var url_nombre  = "<?php echo base_url(); ?>index.php/compras/proveedor/autocomplete/";
            var url_doc     = "<?php echo base_url(); ?>index.php/compras/proveedor/autocomplete_ruc/";
        }
