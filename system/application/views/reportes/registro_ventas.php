  ...
  <section>
    ...
    <div class="row fuente8 py-1">
      ...
      <div class="col-sm-6 col-md-6">
           ...
           <button class="btn btn-primary" id="registro_txt" style="vertical-align:middle" onclick="generar_txt(2)"><span>Anexo TXT </span></button>
           <button class="btn btn-primary" id="registro_txt" style="vertical-align:middle" onclick="generar_txt(1)"><span>Registro TXT </span></button>
...
function generar_txt(pase){
    ...
    if (tipo_docu!="V" && tipo_docu!="F" && tipo_docu!="B" && tipo_docu!="C")
    {
        alert("Disculpe, tipo de Documento no válido.");
        return false;
    }

    postForm('<?php echo base_url(); ?>index.php/reportes/ventas/registro_ventas_txt/', 
        {
            tipo_doc: tipo_docu,
            tipo_oper: tipo_oper,
            fecha1: fecha1,
