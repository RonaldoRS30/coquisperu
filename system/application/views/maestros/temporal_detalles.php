        ...
        <div class="modal-content">
            <form id="form_tempdetalle" method="POST">
                ...
                <div class="modal-body panel panel-default">
                    ...
                    <input type="hidden" class="form-control" name="tempde_peso" id="tempde_peso">
                    ...
                    <div class="row form-group todosAlmacenes">
                    ...
                    <div class="row form-group align-items-center">
							...
							<input type="text" class="form-control h-2 w-porc-90" name="tempde_cantidad" id="tempde_cantidad" value="0" onkeypress="return numbersonly(this, event, '.');"onkeyup="calcular_temProducto_modal();" oninput="this.value = this.value.replace(/[^0-9.]/g, '');">
                        </div>
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <label for="direccion">Valor Unitario</label>
                            <input type="text" class="form-control h-2 w-porc-90" name="tempde_precioUnitario" id="tempde_precioUnitario" value="0.00000" onkeypress="return numbersonly(this,event,',');" onkeyup="calcular_temProducto_modal();" oninput="this.value = this.value.replace(/[^0-9.]/g, '');">
                        </div>
                        <div class="col-sm-3 col-md-3 col-lg-3">
                    ...
                    <div class="row form-group">
                        <div hidden class="col-sm-1 col-md-1 col-lg-1" hidden >
                            <div class="">
                        ...
                        <div hidden class="col-sm-1 col-md-1 col-lg-1" <?=($tipo_docu == "C") ? 'style="display: none"' : "";?>>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var precioContieneIgv  = $('#contiene_igv').val();
        ...
        $("#tempde_producto").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    if(!isEncuentra){
                        ...
                        if($("#flagBS").val()=="B"){
                        fila='';
                        $(".todosAlmacenes").empty();
                        if (ui.item.porAlmacen>0) {
                            $.each(ui.item.porAlmacen, function (i, item) {
                                nombreAlmacen  = item.ALMAC_Descripcion;
                                stockProd       = parseFloat(item.ALMPROD_Stock).toFixed(2);
                               
                                fila += '<div class="col-sm-2 col-md-2 col-lg-2">';
                                    fila += '<label for="cantidad">'+nombreAlmacen+'</label>';
                                    fila += '<input type="text" disabled class="form-control h-2 w-porc-90" value="'+stockProd+'">';
                                fila += '</div>';

                            });
                        }

                        $(".todosAlmacenes").append(fila);
                        }
                        $("#tempde_peso").val(ui.item.peso_item);
    ...
    function agregar_producto_temporal(){
        ...
        peso_item  = parseFloat($("#tempde_peso").val());
        peso       = peso_item*cantidad;
        ...
        if (tipoIgv == '1') {
            ...
            var contieneIgv  = $('#contiene_igv').val();
            var igv100 = $("#igv").val();
            if ( contieneIgv == 0)
        ...
        */
        ...
        fila += '<input type="hidden" name="prodpeso[' + n + ']" id="prodpeso[' + n + ']" value="' + peso + '"/>';
    ...
    function agregar_productotemp_modificado(fila){
        ...
        ct                  = "prodcantidad["+fila+"]";
        var prodcantidadT   = parseFloat(document.getElementById(ct).value);
        peso_item           = (parseFloat($("#tempde_peso").val())/prodcantidadT).toFixed(2);
        peso                = peso_item*cantidad;
        ...
        $.ajax({
            ...
            success:function(data){
                $.each(data.datos, function (i, item) {
                    $("#tempde_peso").val(item.TEMPDE_Peso);
                    ...
                    $("#flagBS").val(item.TEMPDE_FlagBs);
                    $("#tempde_flagBs").val(item.TEMPDE_FlagBs);
    ...
    function array_temporal_producto(datos,detaccion,randomColor = '', serie = null, num_comprobante = null, tipo = null){
        ...
        $.each(datos, function (i, item) {
            ...
            costo           = parseFloat(item.TEMPDE_Costo);
    ...
    function calcular_totales_tempdetalle(){
        ...
        for( i=0; i<n ; i++){
            ...
            if(document.getElementById(e) != null && document.getElementById(e).value != 'e' && document.getElementById(e).value != 'EE'){
                ...
                cantidad        = document.getElementById(pc).value; // CANTIDAD
                peso            = parseFloat(document.getElementById(pe).value); // PESO DEL ITEM
        ...
        $("#peso_total").val(peso_total.format(false));
        
        if (importetotal>=3000 && tipo_oper=="V") {
            $("#forma_pago > option[value=2]").attr("selected",true);
            $("#formapago > option[value=2]").attr("selected",true);
        }
