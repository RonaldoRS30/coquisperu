...
<form id="<?php echo $formulario; ?>" method="post" action="<?php echo $url_action; ?>">
    <input value='<?php echo $compania; ?>' name="sucursal" type="hidden" id="sucursal"/>
            ...
            <table class="fuente8" width="100%" cellspacing="0" cellpadding="5" border="0">
                <tr>
                    ...
                    <td width="60%" valign="middle">
                        ...
                        <input class="cajaGeneral" name="serie" type="text" id="serie" size="3" maxlength="3" value="<?php echo $serie; ?>" <?=($tipo_oper == 'V') ? 'readonly' : '';?>/>&nbsp;
                ...
                <tr>
                    ...
                    <td>
                        <b>Relacionar:</b> <button type="button" class="btn btn-info" onclick="buscar_asocomprobante()">Factura/Boleta</button>
                    </td>
                    <td><b>Serie:</b>
                        <input type="text" name="idSerie" id="idSerie" value="<?=$numserref;?>" class="cajaGeneral" readonly/>
                        </td>
                    <!--<td valign="middle">Guia remision *</td>-->
                    <td valign="middle">
                        <b>Numero:</b><br>
                        <input type="text" name="idNumero" id="idNumero" value="<?=$numdocref;?>" class="cajaGeneral" readonly/>
                        
                       <!-- <select id="origenDocumento"  name="origenDocumento">
                            <option value="F" <?=($ltCompIni=="F") ? "selected":"";?>>FACTURA</option>
                            <option value="B" <?=($ltCompIni=="B") ? "selected":"";?>>BOLETA</option>
                            <option value="C" <?=($ltCompIni=="C") ? "selected":"";?>>COMPROBANTE</option>
                        </select>-->
                    ...
                    <td valign="middle" style="position: relative" hidden>
...
<?php $this->load->view('ventas/modal_asociarComprobante'); ?>
