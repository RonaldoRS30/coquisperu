<!-- MODAL CLIENTE-->
    <div id="modal_asociarComprobante" class="modal fade" role="dialog" data-backdrop="static">
            ...
            <div class="modal-content">
                <form id="" method="POST">
                    ...
                    <div style="text-align: center;">
                        <h3><b>ASOCIAR GUIA DE REMISIÓN</b></h3>
                    </div>
                    <div class="modal-body panel panel-default">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <table class="fuente8 display" id="table-asocomprobante">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" id="salir_modal_guiarem" data-dismiss="modal">Salir</button>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function buscar_asocomprobante() {
            ...
            if (tipo_oper=="V") {
                ...
                if (proveedor=="") {
                    ...
                    $("#salir_modal_guiarem").click();
                    return false;
                }
            }

           
            $("#modal_asociarComprobante").modal("toggle");
            $('#table-asocomprobante').DataTable({
                filter: false,
                destroy: true,
                processing: true,
                searching: true,
