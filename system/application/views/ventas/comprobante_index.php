            ...
            <table class="fuente8 display" id="table-comprobante">
                ...
                <thead>
                    <tr class="cabeceraTabla">
                        ...
                        <th style="width: 08%" data-orderable="true">VENDEDOR</th>
                        <th style="width: 27%" data-orderable="true">RAZON SOCIAL</th>
                        <th style="width: 08%" data-orderable="true">TOTAL</th>
                        <th style="width: 2%" data-orderable="false">ELIM</th>
                        <th style="width: 2%" data-orderable="false">EDIT</th>
                        <th style="width: 2%" data-orderable="false">TCKT</th>
                        <th style="width: 2%" data-orderable="false">PDF</th>
                        <th style="width: 2%" data-orderable="false">SNT</th>
                        <th style="width: 2%" data-orderable="false">XML</th>
                        <th style="width: 2%" data-orderable="false">EMAIL</th>
              ...
              error:function(data){
                ...
                success:function(data){
                    ...
                    if (data.result == "success"){
                        ...
                        $(".modal-canje").modal("hide");
                        location.href = base_url + "index.php/ventas/comprobante/comprobante_editar/" + data.comprobante + "/" + data.tipo_oper + "/" + data.tipo_docu;
