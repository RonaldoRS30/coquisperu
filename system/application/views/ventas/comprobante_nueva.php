...
<input value="<?php echo $guiaremision; ?>" type="hidden" id="guiaremision" />
    ...
    <div id="zonaContenido" align="center">
        ...
        <div id="frmBusqueda">
            <table class="fuente8" width="100%" cellspacing="0" cellpadding="2" border="0">
                <tr>
                    <td style="border-bottom: rgba(0,0,0,.5) thin solid;"></td>
                    <td style="border-bottom: rgba(0,0,0,.5) thin solid;"></td>
                    <td style="border-bottom: rgba(0,0,0,.5) thin solid;"></td>
                    <td style="border-bottom: rgba(0,0,0,.5) thin solid;"></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input class="cajaMedia" name="numero" type="text" id="numero" size="6" maxlength="20" value="<?php echo $numero; ?>" <?=($tipo_oper == 'V') ? 'readonly' : '';?>/>&nbsp;&nbsp;
                        <label style="margin-left:20px;">IGV</label>
                        <input name="igv" type="text" class="cajaGeneral cajaSoloLectura" id="igv" size="3" maxlength="2" value="<?=$igv;?>" onkeypress="return numbersonly(this,event,'.');" onblur="modifica_igv_total();" readonly="readonly"/> %
                        &nbsp;&nbsp;
                        TDC: &nbsp;<input name="tdcDolar" type="text" class="cajaGeneral" style="width: 35px" id="tdcDolar" size="3" value="<?php echo $tdcDolar; ?>" onkeypress="return numbersonly(this,event,'.');" />
                    ...
                    <td><input type="date" class="cajaGeneral cajaSoloLectura" id="fecha" name="fecha" value="<?=$hoy;?>"></td>
                    <td>Fecha de vencimiento</td>
                    <td><input type="date" class="cajaGeneral cajaSoloLectura" id="fecha_vencimiento" name="fecha_vencimiento" value="<?=$fecha_vencimiento;?>"></td>
                ...
                <tr>
                    ...
                    <td>
                        <input style="width: 140px;" type="text" id="oc_cliente" name="oc_cliente" value="<?php echo $oc_cliente; ?>">
                    </td>
                    <td>Descuento:</td>
                    <td><input type="number" class="cajaGeneral" id="descuento" name="descuento" size="2" min="0" max="100" step="0.1" value="<?php echo $descuento; ?>" onKeyPress="return numbersonly(this,event,'.');" onkeyup="calcular_totales_tempdetalle();">
                    </td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="TipCli" id="TipCli" class="comboMedio">
                            <option value="0"> :: SELECCIONE :: </option><?php
                            foreach ($categorias_cliente as $i => $val){ ?>
                            <option value="<?=$val->TIPCLIP_Codigo;?>" <?=($val->TIPCLIP_Codigo == $TIPCLIP_Codigo) ? 'selected' : '';?>><?=$val->TIPCLIC_Descripcion;?></option> 
                            <?php } ?>
                        </select>
                    </td>
                </tr>            
        ...
        <div <?php echo $hidden; ?> class="box-add-product" style="text-align: right; margin-right: 100px;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" id="addItems" name="addItems" style="color:#ffffff;" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" data-backdrop="static" onclick="limpiar_campos_modal(); ">Agregar Items</a>
        </div><br>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($othersFormasP as $key => $otherFP) { ?>
                                            <tr>
                                                ...
                                                <td style="width: 15%;">
                                                    <input type="number" min="0" name="monto[]" value="<?php echo number_format($otherFP->monto, 2)?>" class="form-control h-1 monto" placeholder="Monto" onkeyup="recalcular_montoFP();">
                                                </td>
                                                <td class="text-center" style="width: 10%;">
                                                    <button class="btn btn-sm btn-danger borrar" type="button" onclick="limpiar_montoFP();">x</button>
                                                </td>
                                            </tr>
                                        <?php }
                                            ...
                                            { ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 15%;">
                                                        <input type="number" name="monto[]" value="<?php echo $otherFP->monto?>" class="form-control h-1 monto" placeholder="Monto" onkeyup="recalcular_montoFP();">
                                                    </td>
                                                    <td class="text-center" style="width: 10%;">
