                    ...
                    <table class="fuente8 display" id="table-caja">
                        ...
                        <thead>
                            <tr class="cabeceraTabla">
                                ...
                                <td style="width:30%" data-orderable="true">ESTADO</td>
                ...
                <div class="modal-body panel panel-default">
                    ...
                    <div class="row form-group">
                        <div class="col-md-6 col-lg-6">
                            ...
                            <input type="text" id="codigo_caja" name="codigo_caja" class="form-control h-2 w-porc-90" placeholder="Indique el código" value="" maxlength="30">
                        </div>
                        <div class="col-md-6 col-lg-6">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            ...
                            <select name="tipo_caja" id="tipo_caja" class="form-control w-porc-90 h-3">
                                <?php
                                if ($tipo_caja != NULL){
                                    foreach ($tipo_caja as $indice => $val){ ?>
                                        <option value="<?=$val->tipCa_codigo;?>"><?=$val->tipCa_Descripcion;?></option>
                                    <?php
                                    }
                                } ?>
                            </select>
...
Swal.fire({
    ...
    //cosas agregadas recien  , hay algunas que ya las agregue porque se me paso 
