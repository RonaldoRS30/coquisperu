		...
		<div class="row fuente8 py-1">
			...
			<div class="col-sm-2 col-md-2 col-lg-2 form-group">
				...
				<select name="comprobante" id="comprobante" class="form-control w-porc-90 h-2">
					...
					<option value="14" <?=($cboTipoDoc == "14") ? "selected" : "";?>>Nota de ventas</option>
				</select>
			</div>
		</div>
					...
					<table class="fuente8 display" width="100%" cellspacing="0" cellpadding="3" border="0" id="table-cuentas">
						<thead>
							<tr class="cabeceraTabla">
								<td style="width:08%" data-orderable="false">FECHA</td>
								<td style="width:12%" data-orderable="false">TIPO DOC</td>
								<td style="width:04%" data-orderable="false">SERIE</td>
								<td style="width:06%" data-orderable="false">NÚMERO</td>
								<td style="width:26%" data-orderable="false">RAZON SOCIAL</td>
						...
						<table class="fuente8 display" id="table-pagos">
							<thead>
								<tr>
									...
									<th style="width:40%;" data-orderable="true">OBSERVACIÓN</th>
									<th style="width:05%;" data-orderable="true">ELIMINAR</th>
								</tr>
							</thead>
						...
						<table class="fuente8 display" id="table-cuentasPendientes">
							<thead>
								<tr>
									...
									<th style="width:05%" data-orderable="false">PAGAR</th>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
...
function eliminar_pago(pago) {

	Swal.fire({
		icon: "info",
		title: "¿Está seguro de eliminar este pago?",
		html: "<b class='color-red font-9'>La acción no se puede revertir</b>",
		showConfirmButton: true,
		showCancelButton: true,
		confirmButtonText: "Aceptar",
		cancelButtonText: "Cancelar"
		...
		if (result.value){
			...
			var url = base_url + "index.php/tesoreria/cuentas/eliminar_pago/"+pago;
