    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-3 col-md-3 col-lg-3 pall-0">
          <div id="idDivLogo" class="" style="font-size: 9pt; font-weight: bolder;"><b> 
            <div align="center">GRUPO COQUIS SAC</div> 
            <div align="center">COMERCIALIZACIÓN Y DISTRIBUCIÓN DE GOLOSINAS</div>
            <div align="center">Av La Cultura 701 Pje A27 - Pje B34 - Pje 24 Junio 11</div>
            <div align="center">MERCADO PRODUCTORES SANTA ANITA - LIMA</div></b>
          </div>
        </div>  
        <div class="col-sm-1 col-md-1 col-lg-1 pall-0">
          <div id="idDivLogo" class="">
            <img src="<?php echo base_url();?>images/logoticket.png?=<?=IMG;?>" alt="logo" style="height: 90px; margin-left: 1em; " />
          </div>
        </div>  
        <div class="col-sm-4 col-md-4 col-lg-4 pall-0">
...
<!--MODAL PRECIOS-->
    <div class="modal fade bd-modalVentaDia" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xm">
        <div class="modal-content" style="width: 35%; margin: auto; font-family: Trebuchet MS, sans-serif; font-size: 17px;">
            <div class="titulo" style="text-align: center;">
              <h3>COMPROBANTES DEL DIA</h3>
            </div>
           
            <div class="contenido" style="width: 95%; margin:auto;height: auto;padding-bottom: 15px;">
              
                <form id="frmComprobanteDia" method="post" onsubmit="return false;" style="margin-bottom: 12px;" autocomplete="off">
                  <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                      <div class="col-sm-4 col-md-4  col-lg-4 ">
                        <label for="vfechaini">FECHA INCIO:</label>
                        <input type="date" class="form-control h-1 uppercase" name="vfechaini" id="vfechaini" value="<?=date('Y-m-d')?>">
                      </div>
                       <div class="col-sm-4 col-md-4  col-lg-4 ">
                        <label for="vfechafin">FECHA FIN:</label>
                        <input type="date" class="form-control h-1 uppercase" name="vfechafin" id="vfechafin" value="<?=date('Y-m-d')?>">
                      </div>
                    </div>
                  </div>
                </form>
                <div class="row">
                  <div class="col-sm-11 col-md-11 col-lg-11 text-center">
                    <button type="button" class="btn btn-success" id="mis_ventas" name="mis_ventas" aria-label="Close">Descargar</button>
                    <button type="button" class="btn btn-danger" onclick="cerrarCompDia()" aria-label="Close">Cerrar</button>
                  </div>
                </div>
...
/*VENTANA PRECIOS*/
  ...
  $("#mis_ventasModal").click(function(){
    $('.bd-modalVentaDia').modal('show');
  });
  ...
  function cerrarCompDia()
  {
    $('.bd-modalVentaDia').modal('hide');
  }
...
/*VENTAS DEL DIA*/
  $("#mis_ventas").click(function(){
    ...
    fecha1 = $("#vfechaini").val();
    fecha2 = $("#vfechafin").val();
    forma_pago = '0';
    sucursal = $('#cboCompania').val();

    var url = "<?php echo base_url() ?>index.php/reportes/ventas/registro_ventas_pdf2/"+tipo_oper+"/"+tipo_docu+"/"+fecha1+"/"+fecha2+"/"+forma_pago+"/"+consolidado+"/"+sucursal;
