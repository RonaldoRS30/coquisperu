...
.input-number:focus{color:#212529;background-color:#fff;border-color:#86b7fe;outline:0;box-shadow:0 0 0 .25rem rgba(13,110,253,.25)}
...
.input-number .qty-up:hover, .input-number .qty-down:hover {
  ...
  color: #D10024;
		...
		background: #bec9be;  /* Color de fondo */
		position: fixed;
		top: 50%;
		left: 50%;
		margin-left: -180px;
		...
		background: #f2ffe8;  /* Fondo del mensaje */
...
.ldio-0sdgcnk1lov div { box-sizing: content-box; }
...
<div id='ventana-flotante' class="oculto" style="z-index: 4000!important;">
  ...
  <div class="card-body">
  	<div class="row">
  		<div class="col-md-12">
  			<input type="text" class="form-control teclado" data-kioskboard-type="all" data-kioskboard-specialcharacters="true" id="search" autocomplete="off" onclick="ver_teclado('search');">
  		</div>
