			...
			foreach ($cuentaResult as $i => $val) {
				...
				if ($listado_pago != NULL){
					foreach ($listado_pago as $indice => $valor){
						...
						$btn_elimniar = "<button type='button' onclick='eliminar_pago($valor->PAGP_Codigo)' class='btn btn-default' title='Eliminar pago'><img src='".$this->url."images/delete.png' class='image-size-1'></button>";
