...
class Producto extends Controller{
    ...
    public function nuevo_producto($flagBS = 'B', $flagError = 0){
        ...
        $data["nvo_codigo"]         = "";
        $data["nvo_nombre"]         = "";
        $data["nvo_descripcion"]    = "";
        $data["nvo_codigoSunat"]    = "";
        $data["nvo_autocSunat"]     = "";
        $data["nvo_tipoAfectacion"] = "";
        $data["nvo_familia"]        = "";
        $data["nvo_fabricante"]     = "";
        $data["nvo_marca"]          = "";
        $data["nvo_modelo"]         = "";
        $data["nvo_preciocosto"]    = "0";
        $data["nvo_peso"]           = "0";
        $data["nvo_volumen"]        = "0";
        $data["nvo_stockMin"]       = "0";
    ...
    public function editar_producto($producto, $flagBS='B')
    {
        $data['modo'] = 'editar';
        $data['titulo_tabla']       = "RELACIÓN DE " . ($flagBS == 'B' ? 'ARTICULO' : 'SERVICIO');
        $data['titulo_busqueda']    = "BUSCAR " . ($flagBS == 'B' ? 'ARTICULO' : 'SERVICIO');
    ...
    public function datatable_productos($flagBS = 'B'){
        ...
        if ( count($listado) > 0 ){
            foreach ($listado as $indice => $valor) {
                ...
                $categorias = $this->producto_model->getPrecios($valor->PROD_Codigo, true);
                $j = 6;
                ...
                $lista[$indice][$j] = "<a href='" . site_url('almacen/producto/editar_producto/' . $valor->PROD_Codigo . '/B') . "' class='btn btn-default' title='Editar'>
        ...
        if ($productoResult != NULL){
            ...
            foreach ($productoResult as $i => $val) {
                $productoInfo = array(
                                        ...
                                        "nvo_peso" => $val->PROD_Peso,
                                        "nvo_volumen" => $val->PROD_Volumen,
  ...
  public function guardar_registro(){
        ...
        $nvo_peso = $this->input->post("nvo_peso");
        $nvo_volumen = $this->input->post("nvo_volumen");
        ...
        # REGISTRO PRODUCTO
            ...
            $filter->PROD_Peso                  = $nvo_peso;
            $filter->PROD_Volumen               = $nvo_volumen;
                ...
                if ($size > 0){
                    ...
                    for ($i = 0; $i < $size; $i++){
                        ...
                        # REGISTRO PRECIOS
                            $sizeP = count($precios);
                            for ($j = 0; $j < $sizeP; $j++){
                                $filterPrecioP = new stdClass();
                                $filterPrecioP->PROD_Codigo              = $id;
                                $filterPrecioP->TIPCLIP_Codigo           = $pcategoria[$j];
                                $filterPrecioP->MONED_Codigo             = $pmoneda[$j];
                                
                                $precios_reg = $this->productoprecio_model->buscar($filterPrecioP);
                                
                                $filterPrecioP->EESTABP_Codigo           = $estab;
                                $filterPrecioP->PRODUNIP_Codigo          = $unidad[$i];
                                $filterPrecioP->PRODPREC_PorcGanancia    = NULL;
                                $filterPrecioP->PRODPREC_Precio          = $precios[$j];
                                $filterPrecioP->PRODPREC_FlagEstado      = "1";
                                
                                //busco si tiene precios registrados
                                
                                if ($precios_reg!=NULL) {
                                    $filterPrecioP->PRODPREC_FechaModificacion = date("Y-m-d H:i:s");
                                    $this->productoprecio_model->modificar($precios_reg[0]->PRODPREP_Codigo, $filterPrecioP);
                                    switch ($pcategoria[$j]) {
                                        case '52':
                                           
                                           
                                            $filterPrecio2 = new stdClass();
                                            $filterPrecio2->PROD_Codigo              = $id;
                                            $filterPrecio2->TIPCLIP_Codigo           = 46;
                                            $filterPrecio2->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio2);
                                            
                                            $filterPrecio2->PRODUNIP_Codigo          = $unidad[$i];
                                            $filterPrecio2->PRODPREC_PorcGanancia    = NULL;
                                            $filterPrecio2->PRODPREC_Precio          = $precios[$j];
                                            $filterPrecio2->PRODPREC_FlagEstado      = "1";
                                            if ($precios_reg!=NULL) {
                                                $filterPrecio2->PRODPREC_FechaModificacion  = date("Y-m-d H:i:s");
                                                $this->productoprecio_model->modificar($precios_reg[0]->PRODPREP_Codigo, $filterPrecio2);
                                            }else{
                                                $filterPrecio2->EESTABP_Codigo              = 1215;
                                                 $filterPrecio2->PRODPREC_FechaRegistro     = date("Y-m-d H:i:s");
                                                 $this->productoprecio_model->insertarNvoRegistro($filterPrecio2);
                                            }
                                        ...
                                        case '53':
                                            ...
                                            $filterPrecio2 = new stdClass();
                                            $filterPrecio2->PROD_Codigo              = $id;
                                            $filterPrecio2->TIPCLIP_Codigo           = 47;
                                            $filterPrecio2->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio2);
                                        ...
                                        case '54':
                                            ...
                                            $filterPrecio2 = new stdClass();
                                            $filterPrecio2->PROD_Codigo              = $id;
                                            $filterPrecio2->TIPCLIP_Codigo           = 48;
                                            $filterPrecio2->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio2);
                                        ...
                                        case '55':
                                            ...
                                            $filterPrecio2 = new stdClass();
                                            $filterPrecio2->PROD_Codigo              = $id;
                                            $filterPrecio2->TIPCLIP_Codigo           = 49;
                                            $filterPrecio2->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio2);
                                        ...
                                        case '56':
                                            ...
                                            $filterPrecio2 = new stdClass();
                                            $filterPrecio2->PROD_Codigo              = $id;
                                            $filterPrecio2->TIPCLIP_Codigo           = 50;
                                            $filterPrecio2->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio2);
                                        ...
                                        case '57':
                                            ...
                                            $filterPrecio2 = new stdClass();
                                            $filterPrecio2->PROD_Codigo              = $id;
                                            $filterPrecio2->TIPCLIP_Codigo           = 51;
                                            $filterPrecio2->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio2);
                                        ...
                                        case '34':
                                            ...
                                            $filterPrecio->TIPCLIP_Codigo           = 40;
                                            $filterPrecio->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio);
                                            ...
                                            if ($precios_reg!=NULL) {
                                                ...
                                                $this->productoprecio_model->modificar($precios_reg[0]->PRODPREP_Codigo, $filterPrecio);
                                            }else{
                                                $filterPrecio->EESTABP_Codigo           = 986;
                                                $filterPrecio->PRODPREC_FechaRegistro   = date("Y-m-d H:i:s");
                                                $this->productoprecio_model->insertarNvoRegistro($filterPrecio);
                                            }
                                            if ($pmoneda[$j]==1 && $precios[$j]!="0") {
                                                $this->producto_model->modificar_ultCosto($id, $precios[$j]);
                                            }
                                        ...
                                        case '35':
                                            $filterPrecio = new stdClass();
                                            $filterPrecio->PROD_Codigo              = $id;
                                            $filterPrecio->TIPCLIP_Codigo           = 41;
                                            $filterPrecio->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio);
                                        ...
                                        case '36':
                                            $filterPrecio = new stdClass();
                                            $filterPrecio->PROD_Codigo              = $id;
                                            $filterPrecio->TIPCLIP_Codigo           = 42;
                                            $filterPrecio->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio);
                                        ...
                                        case '37':
                                            $filterPrecio = new stdClass();
                                            $filterPrecio->PROD_Codigo              = $id;
                                            $filterPrecio->TIPCLIP_Codigo           = 43;
                                            $filterPrecio->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio);
                                        ...
                                        case '38':
                                            $filterPrecio = new stdClass();
                                            $filterPrecio->PROD_Codigo              = $id;
                                            $filterPrecio->TIPCLIP_Codigo           = 44;
                                            $filterPrecio->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio);
                                        ...
                                        case '39':
                                            $filterPrecio = new stdClass();
                                            $filterPrecio->PROD_Codigo              = $id;
                                            $filterPrecio->TIPCLIP_Codigo           = 45;
                                            //$filterPrecio->EESTABP_Codigo           = $estab;
                                            $filterPrecio->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio);
                                    ...
                                    $filterPrecioP->PRODPREC_FechaRegistro   = date("Y-m-d H:i:s");
                                    $this->productoprecio_model->insertarNvoRegistro($filterPrecioP);
                                    switch ($pcategoria[$j]) {
                                        case '52':
                                            ...
                                            $filterPrecio2->PROD_Codigo              = $id;
                                            $filterPrecio2->TIPCLIP_Codigo           = 46;
                                            //$filterPrecio2->EESTABP_Codigo           = "1";
                                            $filterPrecio2->MONED_Codigo             = $pmoneda[$j];
                                            $precios_reg = $this->productoprecio_model->buscar($filterPrecio2);
...
//        /* Listado de detalles */
    ...
    */
    ...
    ####################################################################################
    # MASIVO
    # LISTADO DE PRECIO POR PRODUCTO
    # SE CAMBIA PRECIOS MASIVOS Y SE ELIMINA MASIVO
    #
    ####################################################################################
    ...
    public function datatable_listaprecios($flagBS = 'B'){
        ...
        if ( count($listado) > 0 ){
            foreach ($listado as $indice => $valor) {
                $canje = '<input type=checkbox data-producto="'.$valor->PROD_Codigo.'" id="'.$valor->PROD_Codigo.'" onchange="listar_eliminar('.$valor->PROD_Codigo.')">';
                $posPrecio = $valor->PROD_Codigo;
                $divNPC = '<form action="'.base_url().'" method="POST">
                                <input type="number" class="cajaPequena" placeholder="Precio costo" id="'.$posPrecio.'" name="'.$posPrecio.'" step="0.01" min="0.01" value="'.$valor->PROD_UltimoCosto.'"/>
                                <span style="cursor:pointer;" onclick="insertar_costo(\''.$valor->PROD_Codigo.'\',\''.$posPrecio.'\')"> <img class="image-size-1b" src="'.base_url().'images/icono_aprobar.png" id="btnCosto'.$posPrecio.'" name="btnCosto'.$posPrecio.'"/> </span>
                                <img src="'.base_url().'images/loading.gif?='.IMG.'" style="width:24px; display:none" id="loading'.$posPrecio.'" name="loading'.$posPrecio.'">
                            </form>';
                $barcode = " <a onclick='barcode($valor->PROD_Codigo)' style='cursor:pointer;'><img src='" . base_url() . "images/barcode.png' width='40' height='40' border='0' title='Codigo de Barras'></a>";
                ...
                $lista[$indice] = array(
                    ++$pos => $canje,
                    ++$pos => $valor->PROD_CodigoUsuario,
                    ++$pos => $valor->PROD_Nombre,
                    ++$pos => $divNPC
                );
                ...
                foreach ($categorias as $i => $v){
                    ...
                    $j++;*/
                    $lista[$indice][$j] = "<input style='background-color: #c7c6c6; display:none' class='porcen".$validator." cajaPequena' data-prod='".$pro."' data-env='".$pro.$env."' data-check='1' data-porcen='".$porcen."' data-type='".$v->TIPCLIP_Codigo."' style='width : 60px;' type='number' value='".$porcen."' onkeyup='calcular(1,".$pro.$j.")'>

                    
                    <input class='precio".$validator." cajaGrande' data-env='".$pro.$env."' data-id-parent='".$validator."' data-precio='".$dt[0]."' style='width : 80px;' type='number' title='$v->TIPCLIC_Descripcion' value='".$dt[0]."' onkeyup='calcular(2,".$validator.")'>";
                    $j++;
    ...
    public function eliminar_masivo()
    {
        ...
        if ($data) {
            foreach ($data as $key => $value) {
               $this->delete_all($value["ID"]);
            }
        }
    }

    public function delete_all($producto)
    {
        $this->producto_model->eliminar_producto_total($producto);
    }
...
public function precios_productos($flagBS = 'B', $j = '0' ,$limpia=''){
    ...
    $data['totalesCat'][$tam]->total = $pcostoTotal;
    $data['totalesCat'][$tam]->moneda = "S/ ";
    $this->layout->view('almacen/producto_precios', $data);
}

public function datatable_producto_precio($flagBS = 'B'){
