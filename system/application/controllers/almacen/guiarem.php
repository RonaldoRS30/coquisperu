...
#INICIO
    ...
    public function envioGuiaSunat($codigo) {
        ...
        $observacion = ($registro_mtc!="")?$observacion." REGISTRO MTC: ".$registro_mtc:$observacion;
        $observacion = ($licencia!="")?$observacion." BREVETE Nro: ".$licencia: $observacion;
...
#FIN
    ...
    public function nueva($tipo_oper = 'V', $sucursal=''){
        ...
        //Datos de traslado
            ...
            $data['ruc_empresa_transporte']         = "00000000000";
            ...
            $data['recepciona_dni'] = form_input(array("name" => "recepciona_dni", "id" => "recepciona_dni", "class" => "cajaGeneral", "size" => "10", "maxlength" => "8", "value" => "00000000"));
    ...
    public function editar($codigo, $tipo_oper = 'V'){
        ...
        $data['apellido_conductor'] = form_input(array("name" => "apellido_conductor", "id" => "apellido_conductor", "class" => "cajaGeneral", "size" => "27", "maxlength" => "150" ,"value" => $nombre_conductor));
