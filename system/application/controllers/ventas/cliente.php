...
#EXPORTACION DE CLIENTES
	...
	public function expClientes(){
        $this->load->library('Excel');

        $filter->documento 	= "";
		$filter->nombre 	= "";

		$clienteInfo = $this->cliente_model->getClientesExportar($filter);
        
        $this->excel->setActiveSheetIndex(0);
        $this->excel->getActiveSheet()->setTitle('Reporte clientes');
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue("C$lugar", 'NUMERO');
        $this->excel->setActiveSheetIndex(0)->setCellValue("D$lugar", 'NOMBRE');
        $this->excel->setActiveSheetIndex(0)->setCellValue("E$lugar", 'DIRECCION');
        $this->excel->setActiveSheetIndex(0)->setCellValue("F$lugar", 'TELEFONO');
        $this->excel->setActiveSheetIndex(0)->setCellValue("G$lugar", 'MOVIL');
        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", 'CORREO');
        ...
        foreach($clienteInfo as $indice => $valor){
            ...
            ->setCellValue("B$lugar", $valor->documento)
            ->setCellValue("C$lugar", $valor->numero)
            ->setCellValue("D$lugar", $valor->razon_social)
            ->setCellValue("E$lugar", $valor->direccion)
            ->setCellValue("F$lugar", $valor->telefono)
            ->setCellValue("G$lugar", $valor->movil)
            ->setCellValue("H$lugar", $valor->correo);
        ...
        $filename = "Reporte de clientes al ".date('Y-m-d').".xls"; //save our workbook as this file name
